  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/bookingPage1" element={<BookingPage1 />} />
        <Route path="/bookingPage2" element={<BookingPage2 />} />
        <Route path="/bookingPage3" element={<BookingPage3 />} />
        <Route path="/bookingPage4" element={<BookingPage4 />} />
        <Route path="/bookingPage5" element={<BookingPage5 />} />
        <Route path="/bookingPage6" element={<BookingPage6 />} />
        <Route path="/bookingPage7" element={<BookingPage7 />} />
        <Route path="/bookingPage8" element={<BookingPage8 />} />
