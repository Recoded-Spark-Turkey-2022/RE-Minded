        ...
        <div className="form-group">
          <label htmlFor="email">
            ...
            <input
              name="email"
              type="text"
              className={`form-control bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full lg:p-2.5 p-1 ${
