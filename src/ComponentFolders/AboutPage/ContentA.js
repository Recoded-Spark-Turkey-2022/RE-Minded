...
function ContentA() {
  return (
    <div className='relative h-full'>
        <h2 className="absolute font-poppins leading-[75px] text-medium lg:text-large text-black tracking-[-0.01em] left-[13%] top-[13%]">
          HEALING!
        </h2>
        <h3 className="absolute font-poppins text-black text-opacity-50 text-small lg:text-medium leading-6 w-[250px] pt-[20px] left-[13%] top-[28%] lg:top-[27%]">
          some cool one liner !
        </h3>
        <div>
          <p className="text-clip absolute font-poppins lg:text-small text-xsmall leading-6 text-[#424A4F] lg:right-[10%] left-[5%] lg:left-[13%] top-[50%] lg:top-[48%]">
