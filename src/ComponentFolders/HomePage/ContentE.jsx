  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-around w-full lg:h-1/3 pb-4">
        <Card ticket="5 TICKETS" price="10$" button="PURCHASE" buttonPreview />

        <Card ticket="25 TICKETS" price="40$" button="PURCHASE" buttonPreview />

        <Card ticket="50 TICKETS" price="70$" button="PURCHASE" buttonPreview />
      </div>
