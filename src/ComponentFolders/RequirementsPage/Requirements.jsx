  ...
  return (
    <div className="flex lg:flex-row flex-col w-screen h-screen font-poppins ">
      <div className='basis-3/5 lg:ml-28 ml-10 lg:pr-36 md:pr-20 pr-10'>
        ...
        <div >
          <h3 className='lg:text-xl text-lg lg:mt-10 mt-8 font-semibold'>RELIABLE INCOME</h3>
        ...
        <div>
          <h3 className='lg:text-xl text-lg lg:mt-10 mt-8 font-semibold'>FOCUS ON COUNSELING</h3>
          <div className='capitalize lg:text-lg text-base lg:mt-4 mt-2 text-gray-600'>
        ...
        <div>
          <h1 className='lg:text-3xl text-2xl lg:mt-20 mt-16 font-semibold'>REQUIREMENTS</h1>
